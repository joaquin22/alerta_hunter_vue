<template>
  <div>
    <div class="logo-wrapper">
      <router-link to="/">
        <img class="img-fluid for-light" width="50" src="../assets/images/logo/logo-hunter.png" alt />
        <img class="img-fluid for-dark" width="50" src="../assets/images/logo/logo-hunter.png" alt />
      </router-link>
    ...
    <div class="logo-icon-wrapper">
      <router-link to="/">
        <img class="img-fluid" src="../assets/images/logo/logo-hunter.png" width="30" alt />
      </router-link>
    </div>
