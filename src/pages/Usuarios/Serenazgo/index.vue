            ...
            <div class="card-header">
              <h5>
                ...
                <a v-b-modal.modal-usuario class="btn btn-secondary pull-right m-l-10"
                  @click="modal.title = 'Nuevo Serenazgo'">Añadir nuevo serenazgo</a>
              </h5>
            </div>
            <div class="card-body">
              <b-table striped hover responsive :items="usuarios" :fields="fields" :current-page="currentPage"
                :per-page="perPage">
    ...
    <b-modal id="modal-usuario" :title="modal.title" cancel-title="Cancelar" ok-title="Guardar" class="theme-modal"
      ...
      <b-form @submit.stop.prevent="submitForm">
        ...
        <b-form-group id="input-password" label="Contraseña:" label-for="password">
          <b-form-input :state="validateState('password')" id="password" type="password" placeholder="Contraseña"
